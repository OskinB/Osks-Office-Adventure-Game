...
export const information: Information = {
  ...
  osk: {
    name: "Ósk",
    tagline: "She's a frontend developer with a passion for details & UX",
    skills: ["React", "TypeScript", "Vue", "TailwindCSS", "Figma"],
    ...
    whyWorkHere: [
      ...
      {
        answer:
          "It's an exciting challenge to shift from general software development to game development. I hadn't really considered building games with web technologies before.",
        response:
          "Yeah, we like pushing web tech into places it's not supposed to go, keeps things interesting, and mildly terrifying.",
      },
    ],
  },
};
